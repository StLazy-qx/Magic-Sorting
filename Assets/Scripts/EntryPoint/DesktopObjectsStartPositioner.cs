...
public class DesktopObjectsStartPositioner : MonoBehaviour
{
    [Header("Game Objects")]
    ...
    [SerializeField] private Vector3 _desctopCameraPosition;
    [SerializeField] private Vector3 _desctopCameraRotation;
    ...
    {
        _mainCamera.transform.SetPositionAndRotation(_desctopCameraPosition, Quaternion.Euler(_desctopCameraRotation));
